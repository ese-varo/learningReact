...
map  :NERDTreeToggle
nnoremap <silent>  :FZF
map  r :NERDTreeFind      " this is the key to jump to the nerdtree
nnoremap  k :exe "resize +3"
nnoremap  j :exe "resize -3"
nnoremap  l :exe "vertical resize +3"
nnoremap  h :exe "vertical resize -3"
...
silent only
silent tabonly
cd ~/dev/react/learningReact/recipes-app
...
wincmd w
argglobal
if bufexists("~/dev/react/learningReact/reactWithJSX/main.js") | buffer ~/dev/react/learningReact/reactWithJSX/main.js | else | edit ~/dev/react/learningReact/reactWithJSX/main.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
wincmd w
argglobal
if bufexists("src/data/recipes.json") | buffer src/data/recipes.json | else | edit src/data/recipes.json | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
exe 'vert 5resize ' . ((&columns * 79 + 95) / 191)
tabnext 1
badd +15 src/components/Recipe.js
badd +9 src/components/Instructions.js
badd +1 src/components/Ingredients.js
badd +8 src/components/IngredientsList.js
badd +0 src/components/Menu.js
badd +5 src/index.js
badd +0 ~/dev/react/learningReact/reactWithJSX/main.js
badd +0 src/data/recipes.json
